...
5. Universal Links can be disabled, unfortunately. If you are successfully taken into your app via a Universal Link, you'll see "bnc.lt" (or your domain) and a forward button in the top right corner of the status bar. If you click that button, Apple will no longer activate Universal Links in the future. To re-enable Universal Links, go into Safari and enter in bnc.lt/<<four-letter-identifier>>/404. This is not a valid Branch link, so you'll see a "file not found" error. If you have Universal Links set up correctly, then you should be able to swipe down to reveal an iOS-provided banner with an "Open" button. Clicking this will re-enable Universal Links, allowing you to test them again.
