...
You should add this code snippet inside the deep link handler code block. Note that this uses query parameter `$web_only=true`. This should match the [query parameter on the web URL](/marketing-channels/{{ page.title | downcase }}/usage/#flag-your-web-only-links) you enter in the email.
