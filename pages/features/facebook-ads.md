...
### [Get started with Facebook ads!]({{base.url}}/features/facebook-ads/guide)
...
In order for Branch to properly run a Facebook deep linked ad campaign, you must first send Branch your app token.
