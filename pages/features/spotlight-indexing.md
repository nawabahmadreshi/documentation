...
## Getting the spotlightIdentifier

If you need to update or delete your content after submitting it to Spotlight, you can use the `listOnSpotlightWithIdentifierCallback` method:
...
The `identifierCallback` variable is automatically generated by Branch, and can be used with the [standard iOS Spotlight methods](https://developer.apple.com/library/ios/documentation/CoreSpotlight/Reference/CSSearchableIndex_Class/#//apple_ref/doc/uid/TP40016246-CH1-DontLinkElementID_12).
