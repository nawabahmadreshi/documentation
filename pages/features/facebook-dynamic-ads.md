...
1. In the top left hand corner, click the overflow menu and select **Product Catalogs**.{% image src='/img/pages/features/facebook-dynamic-ads/fb-product-catalog.png' half center alt='Facebook Product Catalogs' %}
...
1. Now that you have a product catalog, you can add a new feed. Click "Add New Feed." {% image src='/img/pages/features/facebook-dynamic-ads/add-new-feed.png' half center alt='Add new feed' %}
...
1. Select the Deep Linked Feed CSV file you would like to upload to Facebook, and click "Upload". {% image src='/img/pages/features/facebook-dynamic-ads/successful-feed-upload.png' half center alt='Add new feed' %}
...
Use the "Diagnostics" tab in your Product Catalog view to ensure that Facebook is registering the correct events against your Product Catalog.
