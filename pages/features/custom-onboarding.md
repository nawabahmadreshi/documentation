...
The first thing we need to do is allow your users to create links to share. These links need to contain references to the information we will show new users after signup.
