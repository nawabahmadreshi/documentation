...
title: 3. Universal and App Links
...
App Developer (with Dashboard access)
...
After implementing Universal Links, clicking a Branch link on an iOS device will open the app directly without having to route through a web page first.

{% caution %}Depending on where the link was clicked, this functionality may not be supported. Additional setup may be required.

See [here]({{base.url}}/universal-app-links/support/ios/#appsbrowsers-that-support-universal-links) for more details.{% endcaution %}

After implementing Android App Links, clicking a Branch link on an Android device will open the app directly without having to route through a web page first _or_ prompting the user.
