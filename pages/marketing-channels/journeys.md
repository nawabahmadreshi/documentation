...
| Option | Description |
| --- | --- |
| Platforms | Branch currently offers Journeys on two platforms: **Mobile web** and **AMP Web**. Selecting mobile web will display for mobile users on your website, and AMP Web for users on Google's Accelerated Mobile Pages. [Learn more](/marketing-channels/journeys/amp/).
...
{% protip title="Want to target AMP users?" %}
Select Journeys can be shown on your AMP-compatible website, so you can convert mobile traffic from prioritized Google search results to your app. [Learn how](/marketing-channels/journeys/amp/).
{% endprotip %}
